...
class MW_Cmspro_Block_Adminhtml_News_Edit_Tab_Related extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
    ...
    {
		if(!Mage::registry('cmspronews_data')){
        ...
        return Mage::registry('cmspronews_data');
