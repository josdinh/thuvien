...
class MW_Cmspro_Block_Page_Pager1 extends Mage_Core_Block_Template
{
    ...
    public function getTotalNum()
    {
	    ...
	    Mage::log('pager',Zend_Log::DEBUG,'mylog.log');
	    Mage::log($collection->getSelectSql(true),Zend_Log::DEBUG,'mylog.log');
