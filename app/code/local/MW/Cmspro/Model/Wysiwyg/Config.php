 ...
 */
class MW_Cmspro_Model_Wysiwyg_Config extends Varien_Object
{
    /**
     * Wysiwyg behaviour
     */
   ...
   /* public function getConfig($data = array())
    {
        ...
        $config->setData(array(
            ...
            'files_browser_window_url'      => Mage::getSingleton('adminhtml/url')->getUrl('cmspro_admin/adminhtml_wysiwyg_images/index'),
            'files_browser_window_width'    => (int) Mage::getConfig()->getNode('adminhtml/cms/browser/window_width'),
            'files_browser_window_height'   => (int) Mage::getConfig()->getNode('adminhtml/cms/browser/window_height'),
            'encode_directives'             => true,
            'directives_url'                => Mage::getSingleton('adminhtml/url')->getUrl('cmspro_admin/adminhtml_wysiwyg/directive'),
	...
	public function getPluginSettings($config)
    {
        ...
        $codemirrorWysiwygPlugin = array(array('name' => 'mw_codesyntax',
            'src' => Mage::getBaseUrl('js').'tiny_mce/plugins/mw_codesyntax/editor_plugin.js',
        ),array('name' => 'mw_codeformat',
            'src' => Mage::getBaseUrl('js').'tiny_mce/plugins/mw_codesyntax/editor_plugin.js',
        )
        );
