...
class MW_Cmspro_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('cmspro/image'));
    ...
    public function __toString()
    {
    	try {
            ...
            if(!strlen(Mage::getStoreConfig('mw_cmspro/info/photo_background_color'))){
    ...
    public function getStoreBackgroundColor()
    {
    	...
    	if(Mage::getStoreConfig('mw_cmspro/info/photo_background_color') == "") $background_config = array(255,255,255);
    	else $background_config = $this->hex2rgb(Mage::getStoreConfig('mw_cmspro/info/photo_background_color'));

    	/*$background = Mage::getStoreConfig('mw_cmspro/info/photo_background_color') ? Mage::getStoreConfig('mw_cmspro/info/photo_background_color'):"255,255,255";
