<?php
class CV_Thuvien_Block_Adminhtml_Docgia_Edit_Tab_Muon_Renderer_Tra extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
        ...
        $currentId = 0;
 		...
 		if($order)
 		{
 			$order_id = $order->getEntityId();
      		$result= "<button id='xoa_le_phi' value='Xóa' style='width:85px' onclick='deleteLephi(\"".$deleteLephiUrl."\",".$row['MaTaichanh'].",".$currentId."); return false;'>Trả sách</button>";
