...
class CV_Thuvien_Block_Adminhtml_Docgia_Edit_Tab_Muon_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      ...
      $this->setForm($form);
      $fieldset = $form->addFieldset('docgia_muon_form', array('legend'=>Mage::helper('thuvien')->__('Mượn thêm sách')));
      $muonUrl = "";
      ...
      $addLephiUrl = Mage::helper("adminhtml")->getUrl("thuvien/adminhtml_muontra/muon");
      $fieldset->addField('docgia_muon', 'button', array(
          'value' => 'Mượn',
          'name' => 'docgia_muon',
          'onclick' => 'muon(\''.$muonUrl.'\','.$maDocGia.')',
          'style' => '123',
      ));
